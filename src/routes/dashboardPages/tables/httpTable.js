...
import data from '../src/json/httpTable.log.js'


const title = 'httpTable';

const columns = ["Origin IP", "Origin Port", "Method", "Version", "Status msg", "Info"];
const options = {
    filterType: 'checkbox',
};
...
const config = {
    ...
    cols: [
        ...
        { property: "status_msg", header: "Status msg" },
        { property: "info_msg", header: "Info" },
